        ...
        <form action="{{ route('iuran-sampah.store') }}" method="POST">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('nik') is-invalid @enderror" id="iuranKkInput" name="nik" value="{{ old('nik') }}" list="iuranKkList" autocomplete="off" required placeholder="Ketik nama / No KK">
