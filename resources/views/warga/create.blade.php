        ...
        <form action="{{ route('warga.store') }}" method="POST">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error('ajukan_perpindahan') is-invalid @enderror" name="ajukan_perpindahan" value="{{ old('ajukan_perpindahan', 'tidak') }}" placeholder="Contoh: kedalam_kita / keluar_kota / tidak">
