            ...
            <div class="row g-4">
                    ...
                    <select class="form-select @error('warga_id') is-invalid @enderror" name="warga_id" id="wargaSelect" required>
                        ...
                        @foreach($wargas as $warga)
                            <option value="{{ $warga->id }}"
                                ...
                                {{ old('warga_id', $pilahSampah->warga_id) == $warga->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" id="jkSelect" required>
                        ...
                        <option value="Laki-laki" {{ old('jenis_kelamin', $pilahSampah->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                        <option value="Perempuan" {{ old('jenis_kelamin', $pilahSampah->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                    </select>
                    @error('jenis_kelamin')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('dasawisma') is-invalid @enderror" name="dasawisma" id="dasawismaSelect">
                        ...
                        @foreach(['Dahlia 1','Dahlia 2','Dahlia 3','Dahlia 4','Bougenville 1','Bougenville 2','Bougenville 3'] as $dasa)
                            <option value="{{ $dasa }}" {{ old('dasawisma', $pilahSampah->dasawisma) == $dasa ? 'selected' : '' }}>{{ $dasa }}</option>
                        @endforeach
                    </select>
                    @error('dasawisma')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="col-md-6">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" name="sedekah" id="sedekahCheck" value="1" {{ old('sedekah', $pilahSampah->sedekah) ? 'checked' : '' }}>
