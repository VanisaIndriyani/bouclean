        ...
        <form action="{{ route('pilah-sampah.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('kepala_keluarga_nik') is-invalid @enderror" id="pilahKkInput" name="kepala_keluarga_nik" value="{{ old('kepala_keluarga_nik') }}" list="pilahKkList" autocomplete="off" required placeholder="Ketik nama atau No KK">
